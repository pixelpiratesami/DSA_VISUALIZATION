...
intro_msg = """
Welcome to the Data structure and algorithm visualizations:  

This project provides interactive tools to help students explore and understand how data structures
 work. Through visualizations, you can see how computers organize, store, and manipulate data 
 efficiently, making complex concepts easier to grasp and apply.

{customInstructions}
These visualizations were thoughtfully developed by students from 
